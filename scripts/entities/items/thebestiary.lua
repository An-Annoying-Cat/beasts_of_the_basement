...
if EID then
	EID:addCollectible(Isaac.GetItemIdByName("The Bestiary"), "Marks the nearest vulnerable enemy to the player, making all others of its type weak and giving you a friendly version of it on each floor afterward.")
end
