		...
		if doHouseOfLeaves == true then
			if #slot:Neighbors() == 1 then
				...
				if config.Type == 1 then
					...
					picker:AddOutcomeWeight(RoomType.ROOM_TREASURE, 20) 
					picker:AddOutcomeWeight(RoomType.ROOM_SHOP, 20)
					picker:AddOutcomeWeight(RoomType.ROOM_CURSE, 20)
					picker:AddOutcomeWeight(RoomType.ROOM_ARCADE, 20)
					picker:AddOutcomeWeight(RoomType.ROOM_SACRIFICE, 10)
					picker:AddOutcomeWeight(RoomType.ROOM_CHALLENGE, 10)
					picker:AddOutcomeWeight(RoomType.ROOM_MINIBOSS, 10)
					picker:AddOutcomeWeight(RoomType.ROOM_LIBRARY, 10)
					picker:AddOutcomeWeight(RoomType.ROOM_ISAACS, 5)
					picker:AddOutcomeWeight(RoomType.ROOM_BARREN, 5)
					picker:AddOutcomeWeight(RoomType.ROOM_DEVIL, 5)
					picker:AddOutcomeWeight(RoomType.ROOM_ANGEL, 5)
					local pickerRNG = RNG()
