...
function INNIE_CCW:NPCUpdate(npc)
    ...
    if npc.Type == BotB.Enums.Entities.INNIE_CCW.TYPE and npc.Variant == BotB.Enums.Entities.INNIE_CCW.VARIANT then 
        --Data init...
...
Mod:AddCallback(ModCallbacks.MC_NPC_UPDATE, INNIE_CCW.NPCUpdate, Isaac.GetEntityTypeByName("Innie (CCW)"))