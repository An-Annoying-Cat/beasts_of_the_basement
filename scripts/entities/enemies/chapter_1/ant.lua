...
function ANT:NPCUpdate(npc)


    if npc.Type == BotB.Enums.Entities.ANT.TYPE and npc.Variant == BotB.Enums.Entities.ANT.VARIANT then 
...
Mod:AddCallback(ModCallbacks.MC_NPC_UPDATE, ANT.NPCUpdate, Isaac.GetEntityTypeByName("Ant"))